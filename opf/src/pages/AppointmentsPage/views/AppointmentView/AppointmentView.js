...
export function AdminAppointmentView(props) {}
...
export function StudentAppointmentView(props) {
  ...
  const time_text = (datetime) => {
    ...
    return formatted_value.toLocaleString("en-US", {
      hour: "numeric",
      minute: "numeric",
      hour12: true,
    });
  ...
  const view_ticket_click = () => {
    navigate(
      `/student/maintenance_requests/${appointment.appointment_ticket_id}`
    );
  };
      ...
      <div className={`${styles.view_container} view_layout`}>
        ...
        <div className={`${styles.content_container} view_content_layout`}>
            ...
            <div className={styles.appointment_metadata_container}>
              <div className={styles.metadata_group}>
                ...
                <ItemGroup
                  ...
                  )} to ${time_text(appointment.appointment_end_time)}`}
                />
                <ItemGroup
                  className={`block_contrast_items`}
                  label="Building"
          ...
          <div className={styles.cancellation}>
            ...
            <div
              className={`${
                styles.cancellation_reason
              } ${cancellation_message_background()}`}
            >
