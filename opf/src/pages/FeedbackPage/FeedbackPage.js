  ...
  return (
    <div>
      ...
      <form onSubmit={submitHandler}>
        ...
        <select value="ticket" onChange={selectionHandler}>
        ...
        <textarea value={qOne} onChange={qOneHandler}></textarea>
        <br></br>
        <p>Did maintenance attend to your needs right away?</p>
        <textarea value={qTwo} onChange={qTwoHandler}></textarea>
        <br></br>
        <p>Feedback for the facility?</p>
        <textarea value={qThree} onChange={qThreeHandler}></textarea>
        <br></br>
